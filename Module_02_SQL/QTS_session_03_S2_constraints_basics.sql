...
/* ===========================================================
  ...
  We can only name 4 constraints:
    >> PRIMARY KEY
    >> FOREIGN KEY
    >> UNIQUE
    >> CHECK

  We can not name this 3 CONSTRAINTS (They are called asa pure inline constraints)
    >> AUTO_INCREMENT
    >> NOT NULL
    >> DEFAULT

  INLINE CONSTRAINTS >> All 7 constraints can be use as inline constraint
